...
-- ----------------------------
BEGIN;
INSERT INTO `bahan` (`id`, `nama`, `merk`, `satuan`, `keterangan`, `created_at`, `updated_at`, `harga`, `kode`) VALUES (1, 'bahan A', 'merk', 'buah', '--', '2025-06-07 09:02:54', '2025-06-12 12:33:15', 60000, 'BH01');
COMMIT;
...
CREATE TABLE `biaya` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `barang_awal` int(11) DEFAULT NULL,
  `barang_akhir` int(11) DEFAULT NULL,
  `penjualan` int(11) DEFAULT NULL,
  `overhead_id` int(11) NOT NULL,
  PRIMARY KEY (`id`,`overhead_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `biaya` (`id`, `kode`, `nama`, `bahan_id`, `jenis_id`, `tenaga_kerja_id`, `biaya`, `harga_produksi`, `harga_jual`, `created_at`, `updated_at`, `barang_awal`, `barang_akhir`, `penjualan`, `overhead_id`) VALUES (1, 'BY01', 'produksi 1', 1, 1, 1, 2134, 23423, 2354325, '2025-06-07 11:14:31', '2025-06-12 12:47:27', 5000000, 1000000, 10000000, 2);
COMMIT;
...
CREATE TABLE `jurnal` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`,`biaya_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `jurnal` (`id`, `kode`, `nama`, `tanggal`, `nominal`, `kelompok`, `debit`, `kredit`, `keterangan`, `biaya_id`, `overhead_id`, `created_at`, `updated_at`) VALUES (1, 'JU01', 'jurnal 1', '2025-06-07', '100000', 'kelompok', 'bertambah', 'berkurang', 'keterangan', 1, 2, '2025-06-07 11:48:31', '2025-06-12 12:06:00');
COMMIT;
...
CREATE TABLE `overhead` (
  ...
  `kode` varchar(255) DEFAULT NULL,
  `overhead_variabel` int(11) DEFAULT NULL,
  `overhead_tetap` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `overhead` (`id`, `nama`, `jenis`, `keterangan`, `created_at`, `updated_at`, `jumlah`, `kode`, `overhead_variabel`, `overhead_tetap`) VALUES (2, 'overhead 1', 'jenis overhead', '--', '2025-06-07 11:27:45', '2025-06-12 13:06:22', 100, 'OV01', 1000000, 2000000);
COMMIT;
